package com.cipher.samples.crud;
...
import com.cipher.samples.AttributeExtension;
import com.cipher.samples.backend.data.Availability;
import com.cipher.samples.backend.data.Category;
import com.cipher.samples.backend.data.Product;

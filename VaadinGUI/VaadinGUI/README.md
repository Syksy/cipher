...
- VaadinGUI-widgetset: widgetset, custom client side code and dependencies to widget add-ons
- VaadinGUI-ui: main application module, development time
- VaadinGUI-production: module that produces a production mode WAR for deployment
